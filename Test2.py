...
class Network(IOT):
    def __init__(self):
        ...
        self.Attack_status=np.load('Features/dataset2/Label.npy',allow_pickle=True)
        print("Blockchain driven Personalized Federated Learning Model for intrusion detection and mitigation")
        print()
        self.model = load_model('Models/dataset2/Proposed_model.h5') 
        self.total=[]
    ...
    def FL(self,user_data_, label,data):
        ...
        if self.find==0:
            ...
            file_path = 'Features/dataset2/Server.csv'
